...
int main(int argc, char* argv[])
{
  ...
  // Close connection (The example code never reaches to this section ...)
	...
	igtl::PointMessage::Pointer pMsg;
	pMsg=igtl::PointMessage::New();
	pMsg->SetDeviceName("PointSender");
...
int ReceivePoint(igtl::Socket * socket, igtl::MessageHeader * header)
{
  ...
  if (c & igtl::MessageHeader::UNPACK_BODY) // if CRC check is OK
    ...
    for (int i = 0; i < nElements; i ++)
	  ...
	  igtl::PointMessage::Pointer pMsgRec;
	  pMsgRec=igtl::PointMessage::New();
	  pMsgRec->SetDeviceName("PointerReceiver");
	  ...
	  pMsgRec->AddPointElement(point0);
	  pMsgRec->Pack();

	  igtl::Sleep(500);
	  
	  socket->Send(pMsgRec->GetPackPointer(), pointMsg->GetPackSize());
